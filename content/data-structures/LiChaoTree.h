 ...
 * Date: 2020-10-08
 * License: CC0
 * Source: secmem blog with modifications
 * Description: Convex hull trick. Current implementation is for max query.
 * Be especially aware of overflow. Let $M$ be maximum $x$ coordinate, $aM + b$ should be less than LLMAX.
 * Time: O(\log N)
 * Status:
 */
struct LiChao
